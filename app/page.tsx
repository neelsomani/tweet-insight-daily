...
import S3DataDisplay from "@/components/s3-data-display";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-8">
      ...
      <div className="absolute top-4 right-4">
        <a
          href="https://github.com/neelsomani/tweet-insight-daily"
          target="_blank"
        ...
        <Suspense fallback={
          <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="border-0 shadow-sm bg-white/60 backdrop-blur-sm rounded-lg p-6">
